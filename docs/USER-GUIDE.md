...
- Current application version and GNU AGPL v3-or-later license
...
the repository `TRADEMARKS.md`. The About page is informational; it does not
change configuration or contact external services.
